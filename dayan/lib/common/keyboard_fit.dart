...
class KeyboardFit extends StatefulWidget {
  ...
  _KeyboardFitState createState() => _KeyboardFitState();
}

class _KeyboardFitState extends State<KeyboardFit> with WidgetsBindingObserver {
